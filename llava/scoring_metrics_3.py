...
def evaluate(model):
    ...
    for i in range(data_split, data_split*2):

        print(f'{round((i+1-data_split) / (data_split) * 100, 2)}%')
...
if __name__ == '__main__':
    ...
    scores.to_excel('/mnt/keremaydin/llava/metric_results2.xlsx', index=False)
