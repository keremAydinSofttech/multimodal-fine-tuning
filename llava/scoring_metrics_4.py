...
def evaluate(model):
    ...
    for i in range(data_split*2, data_split*3):

        print(f'{round((i+1-data_split*2) / (data_split) * 100, 2)}%')
...
if __name__ == '__main__':
    ...
    scores.to_excel('/mnt/keremaydin/llava/metric_results3.xlsx', index=False)
