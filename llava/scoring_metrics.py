...
def evaluate(model):
    ...
    for i in range(len(data)):
        ...
        prediction = model.generate_answer(prompt= question, 
                                                 img_path=image_path)

        answer = answer.lower().translate(translation_table)
        prediction = prediction.lower().translate(translation_table)
...
if __name__ == '__main__':
    ...
    scores.to_excel('/mnt/keremaydin/llava/metric_results1.xlsx', index=False)
